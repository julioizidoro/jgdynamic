...
public class ConsultaProdutosContaReceberTableModel extends AbstractTableModel{
    ...
    private String[] colunas ={"código", "Descrição", "Unidade", "Quantidade", "Valor Total"};
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        }else return Formatacao.foramtarFloatString(listaProdutos.get(rowIndex).getValorVenda());
    }
