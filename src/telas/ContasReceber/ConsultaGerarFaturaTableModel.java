 ...
 * @author Wolverine
 */
public class ConsultaGerarFaturaTableModel extends AbstractTableModel{
    
    private List<Contasreceber> listaContasReceber;
    private String[] colunas ={"Nº Documento", "Data Lançamento", "Data Vencimento", "Valor Receber", "Marcada"};

    public ConsultaGerarFaturaTableModel(List<Contasreceber> listaContasReceber) {
