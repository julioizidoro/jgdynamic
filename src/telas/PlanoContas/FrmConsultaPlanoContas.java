...
import telas.planoContas.FrmCadastraGrupoContas;
import telas.planoContas.FrmCadastraPlanoContas;
import telas.planoContas.FrmCadastraSubGrupoContas;

/**
 *
 * @author Wolverine
 */
public class FrmConsultaPlanoContas extends javax.swing.JFrame implements ItelaModel{
    ...
    public FrmConsultaPlanoContas(ItelaConsulta telaConsulta) {
        try {
            ...
            List<Planoconta> listaPlanoContas = facade.consultarPlanoconta();
    ...
    public FrmConsultaPlanoContas(ItelaControleCheque telaCheque) {
        try {
            PlanoContaFacade facade = new PlanoContaFacade();
            List<Planoconta> listaPlanoContas = facade.consultarPlanoconta();
            model = new ConsultaPlanoContasTableModel(listaPlanoContas);
    ...
    public FrmConsultaPlanoContas(IrContasPagar rContasPagar) {
        try {
            PlanoContaFacade facade = new PlanoContaFacade();
            List<Planoconta> listaPlanoContas = facade.consultarPlanoconta();
            model = new ConsultaPlanoContasTableModel(listaPlanoContas);
    ...
    private void initComponents() {
        ...
        adicionarPlanoContasjButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/contamais.png"))); // NOI18N
        adicionarPlanoContasjButton1.setText("Grupo");
        adicionarPlanoContasjButton1.setToolTipText("Adicionar Plano de Contas");
        adicionarPlanoContasjButton1.setFocusable(false);
        adicionarPlanoContasjButton1.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        ...
        adicionarPlanoContasjButton1.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
        ...
        BarradeTarefasjToolBar.add(adicionarPlanoContasjButton2);
    ...
    private void adicionarPlanoContasjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_adicionarPlanoContasjButtonActionPerformed
        JOptionPane.showMessageDialog(rootPane,"Adicionar");
        try {
            new FrmCadastraPlanoContas(new Planoconta(), this);
        } catch (Exception ex) {
            Logger.getLogger(FrmConsultaPlanoContas.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void excluirPlanoContasjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_excluirPlanoContasjButtonActionPerformed
        ...
        if (linha >= 0) {
            ...
            try {
                PlanoContaFacade facade = new PlanoContaFacade();
                facade.excluirPlanoconta(planoContas);
                JOptionPane.showMessageDialog(this, "Dados excluidos com sucesso");
            } catch (Exception ex) {
                ex.printStackTrace();
                JOptionPane.showMessageDialog(this, "Dados não foram excluidos"+ex.getMessage());
            }
        }
    ...
    private void consultaPlanoContasjTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_consultaPlanoContasjTableMouseClicked
        if (evt.getClickCount() == 1) {
            ...
            excluirPlanoContasjButton.setEnabled(true);
        }else if (evt.getClickCount() == 2) {
            int linha = consultaPlanoContasjTable.getSelectedRow();
            if (linha >= 0) {
                if (consulta!=null){
                    Planoconta planoContas = model.listaPlanoConta.get(linha);
                    consulta.setPlanoContas(planoContas);
                }else if (rContasPagar!=null){
                    rContasPagar.cosultarPlanoContas(model.listaPlanoConta.get(linha));
                }else if (this.telaCheque!=null){
                    telaCheque.consultarPlanoContas(model.listaPlanoConta.get(linha));
                }
                this.dispose();
            }
        }
    ...
    private void adicionarPlanoContasjButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_adicionarPlanoContasjButton1ActionPerformed
        new FrmCadastraGrupoContas(new Grupoconta(), null);
    ...
    private void adicionarPlanoContasjButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_adicionarPlanoContasjButton2ActionPerformed
        try {
            new FrmCadastraSubGrupoContas(new Subgrupo());
        } catch (Exception ex) {
            Logger.getLogger(FrmConsultaPlanoContas.class.getName()).log(Level.SEVERE, null, ex);
        }
