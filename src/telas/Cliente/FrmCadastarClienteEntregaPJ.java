 ...
 * @author wolverine
 */
public class FrmCadastarClienteEntregaPJ extends javax.swing.JFrame {
     ...
     */
    public FrmCadastarClienteEntregaPJ(Cliente cliente, Icliente telaConsulta, int tipoOperacao) {
        ...
        try {
            ...
            Logger.getLogger(FrmCadastarClienteEntregaPJ.class.getName()).log(Level.SEVERE, null, ex);
        }
        if (cliente!=null){
