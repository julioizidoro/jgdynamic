 ...
 * @author Wolverine
 */
public class FrmExportarContasPagar extends javax.swing.JFrame implements IrContasPagar{
    ...
    public FrmExportarContasPagar(IContasPagar telaContas) {
...
jButton2.addActionListener(new java.awt.event.ActionListener() {
    ...
    jPanel3.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 10, 90, -1));
    ...
    jPanel3.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 10, 90, -1));
    ...
    public void exportarExcel(String caminho, String nomeArquivo) {
        ...
        String sql = gerarSqlContasPagas();
    ...
    public String gerarSqlContasPagas(){
        String sql = "Select * from viewcontaspagar ";
        sql = sql + " where dataPagamento>='" + Formatacao.ConvercaoDataSql(dataIniciojDateChooser.getDate()) + 
                "' and dataPagamento<='" + Formatacao.ConvercaoDataSql(dataFinaljDateChooser.getDate()) + "' ";
        if (planoContas!=null){
            sql = sql + " and planoconta_idplanoconta=" + planoContas.getIdplanoconta();
        }
        if (fornecedor!=null){
            sql = sql + " and idFornecedor=" + fornecedor.getIdfornecedor();
        }
        sql = sql  + " order by dataPagamento";
        return sql;
    }
}
