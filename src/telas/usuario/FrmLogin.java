...
public class FrmLogin extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (senhajPasswordField.getPassword().length > 0) {
            ...
            this.usuarioLogado = usuariosController.consultarUsuario(nomejTextField.getText(), senha);
            if (usuarioLogado == null) {
                JOptionPane.showMessageDialog(null, "Usuario e/ou Senha não conferem");
            } else {
                new FrmAlterarSenha(usuarioLogado);
            }
        }
        ...
        if (valida.length>0) {
             ...
             if (this.usuarioLogado == null) {
                ...
                if (getTenta() >= 5) {
                    ...
                    if (!this.usuarioLogado.getSenha().equals(senha)) {
                        ...
                        new FrmPrincipal(this.usuarioLogado);
                        this.dispose();
                    }
                }
         }else  JOptionPane.showMessageDialog(null, "Campo senha nulo");
