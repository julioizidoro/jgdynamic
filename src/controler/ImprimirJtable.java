...
public class ImprimirJtable implements Printable {
     ...
     */
    public ImprimirJtable(JTable tabela, String titulo) {

        this.titulo = titulo;
        this.tabela = tabela;
        printerJob = PrinterJob.getPrinterJob();
        printerJob.setPrintable(this);
        printerJob.setJobName(this.titulo);
    ...
    public int print(Graphics g, PageFormat pageFormat, int pageIndex) throws PrinterException {
        ...
        if (pageIndex + 1 == totalNumPages) {
            ...
            graphics2d.setClip(0, (int) (pageHeightForTable * pageIndex), (int) Math.ceil(tableWidthOnPage),
